...
void av1_mbtree_select_segment(const struct AV1_COMP *cpi, MACROBLOCK *mb, BLOCK_SIZE bs,
                               int mi_row, int mi_col)
{
  MBTreeContext *mbctx = &((struct AV1_COMP *)cpi)->mbtree;
  AV1_COMMON *const cm = &((struct AV1_COMP *)cpi)->common;
  int x, y;
